# ============================================================
#  Activa Bolívar SOAT - README para Railway
# ============================================================
...
- Build command: automatico desde Dockerfile
...
`https://activa-bolivar.up.railway.app`
...
2. **Descargas**: Los PDFs se guardan en `/app/downloads` (persistido en Railway)
